...
{
	// const char *cmd = "part list ${devtype} ${devnum}";
	char *devnum, *devtype;
	char devnum_part[12];
...
#endif
	printf("rockchip_read_distro_logo\n");
